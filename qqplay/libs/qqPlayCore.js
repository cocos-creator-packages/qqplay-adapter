var hasWindowObj = !!(typeof window !== 'undefined' && typeof navigator !== 'undefined' && window.document);
var isThirdEngine = !!(typeof cc !== 'undefined' || typeof laya !== 'undefined' || typeof egret !== 'undefined');
var isBrowser = hasWindowObj == true && isThirdEngine == false;
if (isBrowser) {
...
(function (global, factory) {
    if (typeof global === 'object') {
        if (typeof global.MQQ == 'undefined') {
            global.MQQ = {
                ...
                SsoRequest: factory().SsoRequest,
                Account: factory().Account
            };
        }
        if (typeof global.QQ == 'undefined') {
            global.Script = factory().Script;
        }
        if (typeof global.QQ == 'undefined') {
            global.QQ = factory().QQ;
        }
    }
}(BK, function () {
    var Webview = function () {
        ...
        Webview.open = function (url) {
            __browserMsg.send(JSON.stringify({ 'url': url }), 'cs.openWebView.local');
        };
        Webview.openTransparent = function (url, gameOrientation) {
            if (gameOrientation === void 0) {
                gameOrientation = 1;
            }
            __browserMsg.send(JSON.stringify({ 'url': url }), 'cs.openWebViewWithoutUrl.local');
        };
    ...
    var Account = function () {
        ...
        Account.getNick = function (openId, callback) {
            ...
            __browserMsgHdl.addListener('cs.get_userInfo.local', this, this.accountCallBack);
            __browserMsg.send(JSON.stringify({
                'openId': openId,
                'nickname': 1
    ...
    var QQ = function () {
        ...
        QQ.getRankList = function (callback, reqConfig) {
            ...
            if (data != undefined) {
                ...
                __browserMsgHdl.removeListener(this.CMSHOW_SRV_GET_RANK_LIST, this);
                __browserMsgHdl.addListener(this.CMSHOW_SRV_GET_RANK_LIST, this, this._event4GetRankList);
    ...
    QQ.CMSHOW_SRV_REPORT_USER_SCORE = 'apollo_aio_game.report_user_score_3rd';
    QQ.scoreUpload = function (scoreData, callback, arkData) {
        var cmd = this.CMSHOW_SRV_REPORT_USER_SCORE;
        var data = {
            'cmd': cmd,
...
(function (global, factory) {
    ...
    BK.Script.log(1, 1, 'load device.js success');
    return new Device();
}));
...
BK.ScreenShot = function () {
    ...
    this.shotToFile = function (name, type) {
        this.isInScreen();
        var path = 'GameSandBox://' + name + '.' + type;
    ...
    this.shotToFileFromGL = function (gl, name, type) {
        this.isInScreen();
    ...
    this.shotToBuffFromGL = function (gl) {
        this.isInScreen();
        var buff = new BK.Buffer(this.size.height * this.size.width * 4);
        gl.glReadPixels(this.origin.x, this.origin.y, this.size.width, this.size.height, gl.RGBA, gl.UNSIGNED_BYTE, buff);
        return buff;
...
(function (global, factory) {
    ...
    var Text = function () {
        ...
        Object.defineProperty(Text.prototype, 'maxSize', {
            get: function () {
                var mx = {
        ...
        Object.defineProperty(Text.prototype, 'italic', {
            get: function () {
        ...
        Object.defineProperty(Text.prototype, 'horizontalAlign', {
            get: function () {
        ...
        Object.defineProperty(Text.prototype, 'shadowRadius', {
            get: function () {
        ...
        Object.defineProperty(Text.prototype, 'shadowOffset', {
            get: function () {
                var os = {
        ...
        Text.prototype.removeFromParent = function () {
            this.__nativeObj.removeFromParent();
        };
        Text.prototype.setUVFlip = function (flipU, flipV) {
            this.__nativeObj.setUVFlip(flipU, flipV);
        };
        return Text;
    }();
...
(function (global, factory) {
    if (typeof global === 'object') {
        typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.MQQ.Webview.openTransparent = factory().openTransparent;
        global.MQQ.Webview.onMessageHandle = factory().onMessageHandle;
    }
}(BK, function () {
    function openTransparent(url, gameOrientation) {
        if (gameOrientation === void 0) {
            gameOrientation = 1;
        }
        var cmd = 'cs.openWebViewWithoutUrl.local';
...
(function (global, factory) {
    ...
    var Audio = function () {
        ...
        Audio.prototype.startMusic = function (callback) {
            ...
            } else if (GameStatusInfo.platform === 'android') {
...
(function (global, factory) {
    ...
    function upload(buff, callback) {
        ...
        uri = '/' + GameStatusInfo.gameId + '_' + BK.Crypt.bin2hex(BK.Crypt.core_md5(buff)) + '_' + time + '.png';
        ...
        var signKey = BK.Crypt.hex_hmac_sha1(tmpSecretKey, signTime);
...
if (isBrowser) {
    ...
    function __dispatchEvent(errCode, cmd, dataStr) {
        console.log('__dispatchEvent err:' + errCode + ' cmd:' + cmd + ' data:' + dataStr);
        __browserMsgHdl.listenerInfos.forEach(function (listenerInfo) {
...
(function (global, factory) {
    ...
    var Game = function () {
        ...
        Game.prototype._confirmShare = function (shareInfo) {
            var data = shareInfo ? shareInfo : {};
            if (this.platform() == Platform.native) {
                BK.MQQ.SsoRequest.send(data, this.CMSHOW_CS_CMD_SHARE_INFO);
            } else {
                __browserMsg.send(JSON.stringify(data), this.CMSHOW_CS_CMD_SHARE_INFO);
            }
        };
        Game.prototype._onInitGlobalVar = function (errCode, cmd, data) {
            if (this.cfg.onInitGlobalVar) {
                this.cfg.onInitGlobalVar(data, this);
            }
        };
        return Game;
    }();
